...
negative_malignant <- unique(subset(dataset , label == -1)$`patient-id`)
length(negative_malignant)
...
train_positive_malignant <- positive_malignant[train_positive_malignant_v]
...
train_negative_malignant <- negative_malignant[train_negative_malignant_v]
...
train_patient <- unique(c(train_positive_malignant,train_negative_malignant))
...
length(unique(train_patient$`patient-id`))
#Marging the data based on patient id to prepare the train data
...
test_patient <- unique(c(test_positive_malignant,test_negative_malignant))
